...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        SettingsWindow.resize(400, 587)
        self.gridLayoutWidget = QtWidgets.QWidget(SettingsWindow)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 10, 381, 561))
        ...
        self.triggerPortNameLineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.triggerPortNameLineEdit.setObjectName("triggerPortNameLineEdit")
        self.gridLayout.addWidget(self.triggerPortNameLineEdit, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.showStatusLabel, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.portMonitorPushButton, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.setParamsPushButton, 5, 3, 1, 1)
        ...
        self.tracerPortNameLineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.tracerPortNameLineEdit.setObjectName("tracerPortNameLineEdit")
        self.gridLayout.addWidget(self.tracerPortNameLineEdit, 3, 2, 1, 1)
        self.connectPushButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.connectPushButton.setObjectName("connectPushButton")
        self.gridLayout.addWidget(self.connectPushButton, 3, 3, 1, 1)
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.portNameLabel.setText(_translate("SettingsWindow", "trigger port"))
        ...
        self.label.setText(_translate("SettingsWindow", "tracer1 port"))
